...
#per ogni valore di a faccio un grafico nella cartella figures, con anche l'errore
for index, aeval in enumerate(evalues):
    ...
    fig1.suptitle(t="Prime M="+str(M)+" autofunzioni per N="+str(arr_info[index][1])+", L="+str(L)+" e a="+str('%.2f' % a[index]),fontfamily='Serif',fontsize='x-large',fontweight='bold')
